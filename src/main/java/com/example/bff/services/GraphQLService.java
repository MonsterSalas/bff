...
public class GraphQLService {
    ...
    private final WebClient graphQLRolWebClient;

    public GraphQLService(WebClient graphQLUserWebClient, WebClient graphQLRolWebClient) {
        this.graphQLUserWebClient = graphQLUserWebClient;
        this.graphQLRolWebClient = graphQLRolWebClient;
    }
    ...
    public Mono<String> executeRolGraphQLQuery(String query, Object variables) {
        return graphQLRolWebClient.post()
                .bodyValue(createGraphQLRequest(query, variables))
                .retrieve()
                .bodyToMono(String.class);
    }
